...
tg_sendinfo "<code>I am gonna merge staging into King-Ubot</code>"
cd
...
git push --force origin staging:Lynx-Userbot
tg_sendinfo "<code>I have merged all commits from staging into King-Ubot</code>"
